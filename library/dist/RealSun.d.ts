import { DirectionalLight, Scene, TransformNode, Vector3 } from '@babylonjs/core';
...
export declare class RealSun {
    ...
    private _now;
    constructor(_transform: TransformNode, _radius: number, _lat: number, _lng: number, _northDirection: Vector3, _options: RealSunOptions, _scene: Scene, _sunLight?: DirectionalLight | undefined);
